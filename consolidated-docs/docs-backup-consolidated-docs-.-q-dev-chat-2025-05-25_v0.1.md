<!-- Source: /Users/mzahirudeen/playwright-framework-dev/docs-backup/consolidated-docs/.-q-dev-chat-2025-05-25_v0.1.md -->
...
./bin/generate-page "https://wise-koala-a44c19-dev-ed.trailblaze.lightning.force.com/lightning/o/Contact/new" SalesforceContactPage -f salesforce --credentials.username="altimetrikuser001@wise-koala-a44c19.com" --credentials.password="Dubai@2025"
...
Listing tests:
  ...
  [chromium] › docker/docker-verification.spec.js:8:7 › Docker Verification Tests › should verify Docker environment variables are accessible
  [chromium] › docker/docker-verification.spec.js:15:7 › Docker Verification Tests › should verify Docker file system is working
  [chromium] › docker/docker-verification.spec.js:36:7 › Docker Verification Tests › should verify Docker networking is working
  [chromium] › generators/sf-page-generator.spec.js:14:3 › Salesforce Page Generator › should generate a valid page class from elements
  [chromium] › generators/sf-page-generator.spec.js:52:3 › Salesforce Page Generator › findElementsByType should filter elements by type
  [chromium] › generators/sf-page-generator.spec.js:73:3 › Salesforce Page Generator › getElementName should extract name from element attributes
  [chromium] › generators/sf-page-generator.spec.js:106:3 › Salesforce Page Generator › formatName should convert strings to camelCase
  [chromium] › generators/sf-page-generator.spec.js:120:3 › Salesforce Page Generator › getElementSelector should return the best selector
  [chromium] › login.spec.js:25:3 › OrangeHRM Login Tests › should display login page
  [chromium] › login.spec.js:30:3 › OrangeHRM Login Tests › should login with valid credentials
  [chromium] › login.spec.js:38:3 › OrangeHRM Login Tests › should show error with invalid credentials
  [chromium] › login.spec.js:47:3 › OrangeHRM Login Tests › should navigate to forgot password page
  [chromium] › login.spec.js:54:3 › OrangeHRM Login Tests › should logout successfully
  [chromium] › login.spec.js:88:3 › OrangeHRM Dashboard Tests › should display dashboard widgets
  [chromium] › login.spec.js:93:3 › OrangeHRM Dashboard Tests › should navigate to different sections
  [chromium] › pages/ContactPage.spec.js:32:3 › ContactPage Tests › should navigate to new contact page and back
  [chromium] › pages/OrangeHRMLogin.spec.js:25:3 › OrangeHRMLogin Tests › should load the page successfully
  [chromium] › pages/OrangeHRMLogin.spec.js:31:3 › OrangeHRMLogin Tests › should interact with form elements
  [chromium] › pages/OrangeHRMLogin.spec.js:45:3 › OrangeHRMLogin Tests › should navigate using links
  [chromium] › pages/OrangeHRMLogin.spec.js:53:3 › OrangeHRMLogin Tests › should show error with invalid credentials
  [chromium] › pages/SalesforceContactPage.spec.js:36:3 › SalesforceContactPage Tests › should load the page successfully
  [chromium] › pages/SalesforceContactPage.spec.js:42:3 › SalesforceContactPage Tests › should interact with form elements
  [chromium] › pages/SalesforceContactPage.spec.js:51:3 › SalesforceContactPage Tests › should interact with tables
  [chromium] › pages/SalesforceContactPage.spec.js:58:3 › SalesforceContactPage Tests › should interact with lists
  [chromium] › pages/SalesforceContactViewPage.spec.js:36:3 › SalesforceContactViewPage Tests › should load the page successfully
  [chromium] › pages/SalesforceContactViewPage.spec.js:42:3 › SalesforceContactViewPage Tests › should interact with form elements
  [chromium] › pages/SalesforceContactViewPage.spec.js:51:3 › SalesforceContactViewPage Tests › should interact with tables
  [chromium] › pages/SalesforceContactViewPage.spec.js:58:3 › SalesforceContactViewPage Tests › should interact with lists
  [chromium] › pages/SalesforceContactViewPage.spec.js:65:3 › SalesforceContactViewPage Tests › should handle modal dialogs
  [chromium] › pages/SalesforceNewContactDialog.spec.js:30:3 › SalesforceNewContactDialog Tests › should load the page successfully
  [chromium] › pages/SalesforceNewContactDialog.spec.js:36:3 › SalesforceNewContactDialog Tests › should interact with form elements
  [chromium] › pages/SalesforceNewContactDialog.spec.js:49:3 › SalesforceNewContactDialog Tests › should interact with tables
  [chromium] › pages/SalesforceNewContactDialog.spec.js:55:3 › SalesforceNewContactDialog Tests › should interact with lists
  [chromium] › pages/SalesforceNewContactDialog.spec.js:60:3 › SalesforceNewContactDialog Tests › should handle modal dialogs
  [firefox] › docker/docker-verification.spec.js:8:7 › Docker Verification Tests › should verify Docker environment variables are accessible
  [firefox] › docker/docker-verification.spec.js:15:7 › Docker Verification Tests › should verify Docker file system is working
  [firefox] › docker/docker-verification.spec.js:36:7 › Docker Verification Tests › should verify Docker networking is working


  [firefox] › generators/sf-page-generator.spec.js:14:3 › Salesforce Page Generator › should generate a valid page class from elements
  [firefox] › generators/sf-page-generator.spec.js:52:3 › Salesforce Page Generator › findElementsByType should filter elements by type
  [firefox] › generators/sf-page-generator.spec.js:73:3 › Salesforce Page Generator › getElementName should extract name from element attributes
  [firefox] › generators/sf-page-generator.spec.js:106:3 › Salesforce Page Generator › formatName should convert strings to camelCase
  [firefox] › generators/sf-page-generator.spec.js:120:3 › Salesforce Page Generator › getElementSelector should return the best selector
  [firefox] › login.spec.js:25:3 › OrangeHRM Login Tests › should display login page
  [firefox] › login.spec.js:30:3 › OrangeHRM Login Tests › should login with valid credentials
  [firefox] › login.spec.js:38:3 › OrangeHRM Login Tests › should show error with invalid credentials
  [firefox] › login.spec.js:47:3 › OrangeHRM Login Tests › should navigate to forgot password page
  [firefox] › login.spec.js:54:3 › OrangeHRM Login Tests › should logout successfully
  [firefox] › login.spec.js:88:3 › OrangeHRM Dashboard Tests › should display dashboard widgets
  [firefox] › login.spec.js:93:3 › OrangeHRM Dashboard Tests › should navigate to different sections
  [firefox] › pages/ContactPage.spec.js:32:3 › ContactPage Tests › should navigate to new contact page and back
  [firefox] › pages/OrangeHRMLogin.spec.js:25:3 › OrangeHRMLogin Tests › should load the page successfully
  [firefox] › pages/OrangeHRMLogin.spec.js:31:3 › OrangeHRMLogin Tests › should interact with form elements
  [firefox] › pages/OrangeHRMLogin.spec.js:45:3 › OrangeHRMLogin Tests › should navigate using links
  [firefox] › pages/OrangeHRMLogin.spec.js:53:3 › OrangeHRMLogin Tests › should show error with invalid credentials
  [firefox] › pages/SalesforceContactPage.spec.js:36:3 › SalesforceContactPage Tests › should load the page successfully
  [firefox] › pages/SalesforceContactPage.spec.js:42:3 › SalesforceContactPage Tests › should interact with form elements
  [firefox] › pages/SalesforceContactPage.spec.js:51:3 › SalesforceContactPage Tests › should interact with tables
  [firefox] › pages/SalesforceContactPage.spec.js:58:3 › SalesforceContactPage Tests › should interact with lists
  [firefox] › pages/SalesforceContactViewPage.spec.js:36:3 › SalesforceContactViewPage Tests › should load the page successfully
  [firefox] › pages/SalesforceContactViewPage.spec.js:42:3 › SalesforceContactViewPage Tests › should interact with form elements
  [firefox] › pages/SalesforceContactViewPage.spec.js:51:3 › SalesforceContactViewPage Tests › should interact with tables
  [firefox] › pages/SalesforceContactViewPage.spec.js:58:3 › SalesforceContactViewPage Tests › should interact with lists
  [firefox] › pages/SalesforceContactViewPage.spec.js:65:3 › SalesforceContactViewPage Tests › should handle modal dialogs
  [firefox] › pages/SalesforceNewContactDialog.spec.js:30:3 › SalesforceNewContactDialog Tests › should load the page successfully
  [firefox] › pages/SalesforceNewContactDialog.spec.js:36:3 › SalesforceNewContactDialog Tests › should interact with form elements
  [firefox] › pages/SalesforceNewContactDialog.spec.js:49:3 › SalesforceNewContactDialog Tests › should interact with tables
  [firefox] › pages/SalesforceNewContactDialog.spec.js:55:3 › SalesforceNewContactDialog Tests › should interact with lists
  [firefox] › pages/SalesforceNewContactDialog.spec.js:60:3 › SalesforceNewContactDialog Tests › should handle modal dialogs
  [webkit] › docker/docker-verification.spec.js:8:7 › Docker Verification Tests › should verify Docker environment variables are accessible
  [webkit] › docker/docker-verification.spec.js:15:7 › Docker Verification Tests › should verify Docker file system is working
  [webkit] › docker/docker-verification.spec.js:36:7 › Docker Verification Tests › should verify Docker networking is working
  [webkit] › generators/sf-page-generator.spec.js:14:3 › Salesforce Page Generator › should generate a valid page class from elements
  [webkit] › generators/sf-page-generator.spec.js:52:3 › Salesforce Page Generator › findElementsByType should filter elements by type
  [webkit] › generators/sf-page-generator.spec.js:73:3 › Salesforce Page Generator › getElementName should extract name from element attributes
  [webkit] › generators/sf-page-generator.spec.js:106:3 › Salesforce Page Generator › formatName should convert strings to camelCase
  [webkit] › generators/sf-page-generator.spec.js:120:3 › Salesforce Page Generator › getElementSelector should return the best selector
  [webkit] › login.spec.js:25:3 › OrangeHRM Login Tests › should display login page
  [webkit] › login.spec.js:30:3 › OrangeHRM Login Tests › should login with valid credentials
  [webkit] › login.spec.js:38:3 › OrangeHRM Login Tests › should show error with invalid credentials
  [webkit] › login.spec.js:47:3 › OrangeHRM Login Tests › should navigate to forgot password page
  [webkit] › login.spec.js:54:3 › OrangeHRM Login Tests › should logout successfully
  [webkit] › login.spec.js:88:3 › OrangeHRM Dashboard Tests › should display dashboard widgets
  [webkit] › login.spec.js:93:3 › OrangeHRM Dashboard Tests › should navigate to different sections
  [webkit] › pages/ContactPage.spec.js:32:3 › ContactPage Tests › should navigate to new contact page and back
  [webkit] › pages/OrangeHRMLogin.spec.js:25:3 › OrangeHRMLogin Tests › should load the page successfully
  [webkit] › pages/OrangeHRMLogin.spec.js:31:3 › OrangeHRMLogin Tests › should interact with form elements
  [webkit] › pages/OrangeHRMLogin.spec.js:45:3 › OrangeHRMLogin Tests › should navigate using links
  [webkit] › pages/OrangeHRMLogin.spec.js:53:3 › OrangeHRMLogin Tests › should show error with invalid credentials
  [webkit] › pages/SalesforceContactPage.spec.js:36:3 › SalesforceContactPage Tests › should load the page successfully
  [webkit] › pages/SalesforceContactPage.spec.js:42:3 › SalesforceContactPage Tests › should interact with form elements
  [webkit] › pages/SalesforceContactPage.spec.js:51:3 › SalesforceContactPage Tests › should interact with tables
  [webkit] › pages/SalesforceContactPage.spec.js:58:3 › SalesforceContactPage Tests › should interact with lists
  [webkit] › pages/SalesforceContactViewPage.spec.js:36:3 › SalesforceContactViewPage Tests › should load the page successfully
  [webkit] › pages/SalesforceContactViewPage.spec.js:42:3 › SalesforceContactViewPage Tests › should interact with form elements
  [webkit] › pages/SalesforceContactViewPage.spec.js:51:3 › SalesforceContactViewPage Tests › should interact with tables
  [webkit] › pages/SalesforceContactViewPage.spec.js:58:3 › SalesforceContactViewPage Tests › should interact with lists
  [webkit] › pages/SalesforceContactViewPage.spec.js:65:3 › SalesforceContactViewPage Tests › should handle modal dialogs
  [webkit] › pages/SalesforceNewContactDialog.spec.js:30:3 › SalesforceNewContactDialog Tests › should load the page successfully
  [webkit] › pages/SalesforceNewContactDialog.spec.js:36:3 › SalesforceNewContactDialog Tests › should interact with form elements
  [webkit] › pages/SalesforceNewContactDialog.spec.js:49:3 › SalesforceNewContactDialog Tests › should interact with tables
  [webkit] › pages/SalesforceNewContactDialog.spec.js:55:3 › SalesforceNewContactDialog Tests › should interact with lists
  [webkit] › pages/SalesforceNewContactDialog.spec.js:60:3 › SalesforceNewContactDialog Tests › should handle modal dialogs
...
[1A[2K[1/4] [chromium] › tests/pages/OrangeHRMLogin.spec.js:45:3 › OrangeHRMLogin Tests › should navigate using links


[1A[2K[2/4] [chromium] › tests/pages/OrangeHRMLogin.spec.js:25:3 › OrangeHRMLogin Tests › should load the page successfully


[1A[2K[3/4] [chromium] › tests/pages/OrangeHRMLogin.spec.js:31:3 › OrangeHRMLogin Tests › should interact with form elements


[1A[2K[4/4] [chromium] › tests/pages/OrangeHRMLogin.spec.js:53:3 › OrangeHRMLogin Tests › should show error with invalid credentials
...
```
src/utils/ci/
├── backup/                  # Backup of redundant files
│   ├── ciIntegration.js
│   └── flakyTestTracker.js  # ES Modules version
├── ciUtils.js               # Main CI utilities
├── flakyTestTracker.js      # CommonJS version
├── testCoverageAnalyzer.js  # Test coverage analysis
├── testQualityDashboard.js  # Test quality dashboard
├── testSelector.js          # Smart test selection
...
```
src/utils/cli/
├── cliUtils.js  # Main CLI utilities
├── index.js     # Central export point
└── README.md    # Documentation
```
...
```
src/utils/common/
├── dataOrchestrator.js   # Test data management
├── dataUtils.js          # Data reading and parsing
├── errorHandler.js       # Error handling for Playwright
├── index.js              # Central export point
├── logger.js             # Logging utility
├── playwrightService.js  # Browser automation service
├── playwrightUtils.js    # Advanced browser automation
├── retryWithBackoff.js   # Retry mechanism
...
```
src/utils/data/
├── dataGenerator.js  # Basic data generation
├── index.js          # Central export point
└── README.md         # Documentation
```
...
├── config.js              # Configuration settings
├── domCollections.js      # DOM collections utilities
├── element-extractor.js   # Element extraction
├── generate-page.js       # CLI entry point
├── index.js               # Central export point (new)
├── page-generator.js      # Main page object generation
├── selectors.js           # Selector patterns
└── sf-page-generator.js   # Salesforce compatibility
```
...
├── localizationUtils.js  # Localization testing functionality
├── index.js              # Central export point
└── README.md             # Documentation
```

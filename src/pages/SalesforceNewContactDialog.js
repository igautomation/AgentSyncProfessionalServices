...
class SalesforceNewContactDialog extends BasePage {
  ...
  constructor(page) {
    ...
    // Selectors
    // Buttons
    this.global_actions = '[data-aura-rendered-by="19:1497;a"]';
    ...
    this.locked_name__item_test_contact_1748525199250 = '[data-aura-rendered-by="1224:0"]';
    ...
    this.edit_phone__item_null = '[data-aura-rendered-by="1286:0"]';
    this.edit_email__item_null = '[data-aura-rendered-by="1305:0"]';
    ...
    this.button = '[data-aura-rendered-by="5:1497;a"]';
    ...
    this.select_50_items = '[data-aura-rendered-by="28:719;a"]';
    this.select_50_items_column_width = '[aria-label="Select 50 items Column Width"]';
    ...
    // Lists
    this.list = '[data-aura-rendered-by="141:1497;a"]';
  ...
  /**
   * Click Locked Name: Item Test Contact 1748525199250 button
   */
  async clickLocked_name__item_test_contact_1748525199250() {
    await this.click(this.locked_name__item_test_contact_1748525199250);
  }
  ...
  /**
   * Click Edit Phone: Item null button
   */
  async clickEdit_phone__item_null() {
    await this.click(this.edit_phone__item_null);
  }

  /**
   * Click Edit Email: Item null button
   */
  async clickEdit_email__item_null() {
    await this.click(this.edit_email__item_null);
  }
  ...
  /**
   * Fill Select 50 items
   * @param {string} value
   */
  async fillSelect_50_items(value) {
    await this.fill(this.select_50_items, value);
  }

  /**
   * Fill Select 50 items Column Width
   * @param {string} value
   */
  async fillSelect_50_items_column_width(value) {
    await this.fill(this.select_50_items_column_width, value);
  }
  ...
  async getRecently_viewedRows() {
    ...
    for (const row of rows) {
      ...
      const headers = ["Item Number","","SortNameShow Name Column Actions","SortAccount NameShow Account Name Column Actions","SortAccount SiteShow Account Site Column Actions","SortPhoneShow Phone Column Actions","SortEmailShow Email Column Actions","SortContact Owner AliasShow Contact Owner Alias Column Actions","Action","Test Contact 1748525199250\n\nLocked Name: Item Test Contact 1748525199250","Test Contact 1748522284248\n\nLocked Name: Item Test Contact 1748522284248","Test Contact 1748522218632\n\nLocked Name: Item Test Contact 1748522218632","Test Contact 1748521503426\n\nLocked Name: Item Test Contact 1748521503426","Test Contact 1748510321456\n\nLocked Name: Item Test Contact 1748510321456","Test Contact 1748508838424\n\nLocked Name: Item Test Contact 1748508838424","Test Contact 1748507671591\n\nLocked Name: Item Test Contact 1748507671591","Test Contact 1748507559574\n\nLocked Name: Item Test Contact 1748507559574","Test Contact 1748507270855\n\nLocked Name: Item Test Contact 1748507270855","Test Contact 1748503939147\n\nLocked Name: Item Test Contact 1748503939147","Test Contact 1748463185864\n\nLocked Name: Item Test Contact 1748463185864","Test Contact 1748458948430\n\nLocked Name: Item Test Contact 1748458948430","Test Contact 1748458379897\n\nLocked Name: Item Test Contact 1748458379897","Test Contact 1748458215102\n\nLocked Name: Item Test Contact 1748458215102","Test Contact 1748456882409\n\nLocked Name: Item Test Contact 1748456882409","Test Contact 1748456868974\n\nLocked Name: Item Test Contact 1748456868974","Test Contact3980\n\nLocked Name: Item Test Contact3980","Cloyd Connelly\n\nLocked Name: Item Cloyd Connelly","Westley Yundt\n\nLocked Name: Item Westley Yundt","Kailey Wilkinson\n\nLocked Name: Item Kailey Wilkinson","Meggie Blanda\n\nLocked Name: Item Meggie Blanda","Braulio Harber\n\nLocked Name: Item Braulio Harber","Kay Cassin-Collier\n\nLocked Name: Item Kay Cassin-Collier","Oswaldo Larson\n\nLocked Name: Item Oswaldo Larson","Miracle Bechtelar\n\nLocked Name: Item Miracle Bechtelar","DD\n\nLocked Name: Item DD","AA\n\nLocked Name: Item AA"];
